...
<c:choose>
	...
	<c:otherwise>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/purify.min.js"></script>
		...
		<%-- 客制化js --%>
		<script type="text/javascript" src="${commonResourcePath}/training/js/training.js"></script>
